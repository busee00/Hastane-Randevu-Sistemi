...
<nav class="navbar bg-white shadow-sm fixed-top">
    <div class="container-fluid">
        <a class="navbar-brand fw-bold text-primary" href="admin_randevular.php">
            <i class="fa-solid fa-hospital-user me-2"></i> Hasta Paneli
        </a>
        ...
        <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" style="width: 300px;">
            <div class="offcanvas-header menu-ust border-bottom">
			    ...
			    <div class="profil-alani">
			        <img class="profil-foto" src="images/patient.jpeg" alt="Hasta">
			        <?php if (isset($_SESSION['ad'])): ?>
            ...
            <div class="offcanvas-body p-0">
				...
				<ul class="navbar-nav">
				    <li class="nav-item border-bottom">
				        <a class="nav-link px-4 py-3 <?php echo ($aktif_sayfa == 'hasta_randevu_al.php') ? 'fw-bold text-primary' : ''; ?>" href="hasta_randevu_al.php">
				            <i class="fa-solid fa-calendar-check me-3 text-primary"></i> Randevu Al
				        </a>
				    </li>
				    <li class="nav-item border-bottom">
				        <a class="nav-link px-4 py-3 <?php echo ($aktif_sayfa == 'hasta_randevular.php') ? 'fw-bold text-primary' : ''; ?>" href="hasta_randevular.php">
				            <i class="fa-solid fa-stethoscope me-3 text-primary"></i> Randevularım
				        </a>
				    </li>
				    <li class="nav-item border-bottom">
				        <a class="nav-link px-4 py-3 <?php echo ($aktif_sayfa == 'hasta_profil.php') ? 'fw-bold text-primary' : ''; ?>" href="hasta_profil.php">

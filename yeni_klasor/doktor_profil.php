...
$sorgu = $db->prepare("SELECT * FROM doktorlar WHERE d_id = ?");
$sorgu->execute([$d_id]);
...
<head>
    ...
    <title>Profil Bilgilerim | Doktor Paneli</title>
                    ...
                    <div class="card-body p-4 pt-0">
                        <div class="profile-avatar-container text-center" style="margin-top: -50px;">
                            <div class="profile-avatar shadow-sm border border-4 border-white mx-auto">
                                <?php echo strtoupper(substr($doktor['d_ad'], 0, 1)); ?>
                            </div>
                            <h4 class="fw-bold mt-3 mb-1"><?php echo $doktor['d_ad'] . " " . $doktor['d_soyad']; ?></h4>
                            <span class="badge bg-light text-primary border px-3 py-2 rounded-pill">Doktor</span>
                        </div>
                        ...
                        <form action="db_islem.php" method="POST" class="mt-4">
                            <div class="row g-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="d_ad" class="form-control custom-input" value="<?php echo $doktor['d_ad']; ?>" required>
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label small fw-bold text-secondary">Soyadınız</label>
                                    <input type="text" name="d_soyad" class="form-control custom-input" value="<?php echo $doktor['d_soyad']; ?>" required>
                                </div>
                                <div class="col-12">
                                    <label class="form-label small fw-bold text-secondary">E-posta Adresiniz</label>
                                    <input type="email" name="e_mail" class="form-control custom-input" value="<?php echo $doktor['e_mail']; ?>" required>
                                </div>
                                ...
                                <div class="col-12 mt-4">
                                    <button type="submit" name="doktor_profil_guncelle" class="btn btn-primary w-100 py-2 rounded-pill shadow-sm">
